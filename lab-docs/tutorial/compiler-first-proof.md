...
This lesson uses the experimental compiler in `igniter-compiler/`. It is a lab
walkthrough, not a stable language tutorial.
...
- stable grammar;
- public compiler API;
- `.igapp` execution support;
- VM correctness;
- Reference Runtime status;
- release readiness;
- performance, certification, or portability.
...
The compiler is an experimental lab package. Passing this lesson produces
proof-local evidence only and does not promote lab behavior into canon.
