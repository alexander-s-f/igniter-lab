    ...
    tauri::Builder::default()
        ...
        .register_uri_scheme_protocol("igniter-proof", |_ctx, request| {
            ...
            if path == "/" || path == "/index.html" {
                let ssr_path = commands::resolve_workspace_path("frame-ui/igniter-view-engine/out/tabs_ssr_output.html");
...
<body>
  ...
  <script src="igniter-proof://localhost/assets/igniter_view_runtime.js"></script>
                ...
                let js_path = commands::resolve_workspace_path("frame-ui/igniter-view-engine/igniter_view_runtime.js");
